...
<div class="nav">
	<ul class="w1000 clear">
		<li><a href="../talk/index.do">宣讲会</a></li>
			...
			<table border="0" cellspacing="0" cellpadding="0" class="myLxtable"
				...
				<tbody>
					...
					<c:forEach var='news' items="${list}">
						<c:url var="newsUrl" value="./get.do">
							<c:param name="id" value="${news.id}" />
						</c:url>
						<tr style="background: white;">
							<td class="myNm"><a title="${news.title}"
								class="titleAnchor" target="_blank" href="${newsUrl}">${news.title}</a>
							</td>
							<td>${news.addTime}</td>
							<td>${news.click}</td>
						</tr>
